    ...
    <div className="space-y-1">
      ...
      <div className="bg-white rounded-sm border border-table-border">
        <div className="flex items-center gap-2 px-3 h-8 bg-table-header border-b border-table-border">
          ...
          <span className="text-xs font-semibold uppercase tracking-wide text-gray-700">Fecha y Hora del Sistema</span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 p-2">
          <div>
            <label className="block text-2xs uppercase tracking-wide text-text-muted mb-0.5">Fecha y Hora</label>
            <input
              type="datetime-local"
              value={editDateTime}
          ...
          <div>
            <label className="block text-2xs uppercase tracking-wide text-text-muted mb-0.5">Offset UTC</label>
            <input
              type="number"
              value={editUtcOffset}
          ...
          <div>
            <label className="block text-2xs uppercase tracking-wide text-text-muted mb-0.5">Sincronizacion NTP</label>
