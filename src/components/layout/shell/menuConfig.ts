...
export const menuItems: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      { id: 'transactions.list', label: 'General', icon: Receipt, permission: 'transactions.view' },
      { id: 'transactions.fuel', label: 'Combustible', icon: FuelIcon, permission: 'transactions.view' },
...
export const sectionTitles: Record<string, string> = {
  ...
  'transactions.list': 'General',
  'transactions.fuel': 'Combustible',
